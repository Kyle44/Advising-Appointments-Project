...
if($_SESSION['lastPage'] != "StudentOptions.php"){
	...
	// Not sure if this works, but I believe this will give me the date and time of right now.
...
?>
	...
	<!--  THE BUTTONS "Go Back" and "Done".  I don't think that I need 2 buttons here when they should go to the same place.  -->
	...
	<!-- Post method to go to index.php.  Name means StudentViewApts.php (this page) to StudentOptions.php  -->
	<form action='StudentOptions.php' method='post' name='SVAtoINDEX'>
	<!-- Done button  -->
	<input type='Done'>
	<!-- End of form -->
	</form>
